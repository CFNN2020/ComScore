...
df_uk= pd.read_sql_query(
    'select * from uk_comscore_adv_audiences_gaming_index', 
    con=work_engine)
...
x = df_uk['media_property']
y1 = df_uk['pc_percent_reach']
y1_1 = df_uk['console_percent_reach']
y1_2 = df_uk['mobile_percent_reach']
y1_3 = df_uk['esports_percent_reach']
y2 = df_uk['pc_composition_index_uv']
y2_1 = df_uk['console_composition_index_uv']
y2_2 = df_uk['mobile_composition_index_uv']
y2_3 = df_uk['esports_composition_index_uv']
table_data = df_uk[['media_property', 'pc_percent_reach','pc_composition_index_uv']]
table_data2 = df_uk[['media_property', 'console_percent_reach','console_composition_index_uv']]
table_data3 = df_uk[['media_property', 'mobile_percent_reach','mobile_composition_index_uv']]
table_data4 = df_uk[['media_property', 'esports_percent_reach','esports_composition_index_uv']]
...
fig2.layout.yaxis2.update({'anchor': 'x3'})
...
@app.callback(
    Output(component_id='uk_comp_graph', component_property='figure'),
    Input(component_id='uk_views_dropdown', component_property='value'),
)

def build_graph(column_chosen):
    fig = px.pie(df_uk, values=column_chosen, names='media_property', hole=(0.4))
    return fig